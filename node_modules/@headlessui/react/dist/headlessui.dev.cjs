...
var useIsoMorphicEffect = (effect, deps) => {
  if (env.isServer) {
    (0, import_react5.useEffect)(effect, deps);
  } else {
    (0, import_react5.useLayoutEffect)(effect, deps);
  }
};
...
function useActivePress({ disabled = false } = {}) {
  let target = (0, import_react8.useRef)(null);
  let [pressed, setPressed] = (0, import_react8.useState)(false);
...
var DisabledContext = (0, import_react9.createContext)(void 0);
function useDisabled() {
  return (0, import_react9.useContext)(DisabledContext);
}
function DisabledProvider({
  value,
  children
}) {
  return /* @__PURE__ */ import_react9.default.createElement(DisabledContext.Provider, { value }, children);
}
...
function _render(props, slot = {}, tag, name, mergeRefs) {
  ...
  if (Component === import_react10.Fragment) {
    if (Object.keys(compact(rest)).length > 0 || Object.keys(compact(dataAttributes)).length > 0) {
      if (!(0, import_react10.isValidElement)(resolvedChildren) || Array.isArray(resolvedChildren) && resolvedChildren.length > 1) {
  ...
  return (0, import_react10.createElement)(
    ...
    Object.assign(
      {},
      omit(rest, ["ref"]),
      Component !== import_react10.Fragment && refRelatedProps,
      Component !== import_react10.Fragment && dataAttributes
    ),
    resolvedChildren
  );
}
function useMergeRefsFn() {
  let currentRefs = (0, import_react10.useRef)([]);
  let mergedRef = (0, import_react10.useCallback)((value) => {
...
function forwardRefWithAs(component) {
  var _a2;
  return Object.assign((0, import_react10.forwardRef)(component), {
...
function ButtonFn(props, ref) {
  ...
  let slot = (0, import_react11.useMemo)(() => {
...
function useControllable(controlledValue, onChange, defaultValue) {
  let [internalValue, setInternalValue] = (0, import_react12.useState)(defaultValue);
  let isControlled = controlledValue !== void 0;
  let wasControlled = (0, import_react12.useRef)(isControlled);
  let didWarnOnUncontrolledToControlled = (0, import_react12.useRef)(false);
  let didWarnOnControlledToUncontrolled = (0, import_react12.useRef)(false);
...
// src/internal/form-fields.tsx
var FormFieldsContext = (0, import_react14.createContext)(null);
function FormFieldsProvider(props) {
  let [target, setTarget] = (0, import_react14.useState)(null);
  return /* @__PURE__ */ import_react14.default.createElement(FormFieldsContext.Provider, { value: { target } }, props.children, /* @__PURE__ */ import_react14.default.createElement(Hidden, { features: 4 /* Hidden */, ref: setTarget }));
}
function HoistFormFields({ children }) {
  let formFieldsContext = (0, import_react14.useContext)(FormFieldsContext);
  ...
  return target ? (0, import_react_dom.createPortal)(/* @__PURE__ */ import_react14.default.createElement(import_react14.default.Fragment, null, children), target) : null;
}
function FormFields({
  data,
  form: formId,
  ...
  let [form, setForm] = (0, import_react14.useState)(null);
  let d = useDisposables();
  ...
  return /* @__PURE__ */ import_react14.default.createElement(HoistFormFields, null, /* @__PURE__ */ import_react14.default.createElement(FormResolver, { setForm, formId }), objectToFormEntries(data).map(([name, value]) => {
...
function FormResolver({
  ...
  return formId ? null : /* @__PURE__ */ import_react14.default.createElement(
    Hidden,
    {
      features: 4 /* Hidden */,
      as: "input",
...
var IdContext = (0, import_react15.createContext)(void 0);
function useProvidedId() {
  return (0, import_react15.useContext)(IdContext);
}
function IdProvider({ id, children }) {
  return /* @__PURE__ */ import_react15.default.createElement(IdContext.Provider, { value: id }, children);
}
...
function useSyncRefs(...refs) {
  let cache = (0, import_react16.useRef)(refs);
...
// src/components/description/description.tsx
var DescriptionContext = (0, import_react17.createContext)(null);
DescriptionContext.displayName = "DescriptionContext";
function useDescriptionContext() {
  let context = (0, import_react17.useContext)(DescriptionContext);
  if (context === null) {
    let err = new Error(
...
function useDescribedBy() {
  var _a2, _b;
  return (_b = (_a2 = (0, import_react17.useContext)(DescriptionContext)) == null ? void 0 : _a2.value) != null ? _b : void 0;
}
function useDescriptions() {
  let [descriptionIds, setDescriptionIds] = (0, import_react17.useState)([]);
  return [
    ...
    (0, import_react17.useMemo)(() => {
      return function DescriptionProvider(props) {
        ...
        let contextBag = (0, import_react17.useMemo)(
          () => ({
            register,
            slot: props.slot,
            name: props.name,
        ...
        return /* @__PURE__ */ import_react17.default.createElement(DescriptionContext.Provider, { value: contextBag }, props.children);
      };
    }, [setDescriptionIds])
  ];
}
...
function DescriptionFn(props, ref) {
  let internalId = (0, import_react13.useId)();
  let providedDisabled = useDisabled();
  ...
  let slot = (0, import_react17.useMemo)(() => ({ ...context.slot, disabled }), [context.slot, disabled]);
...
var LabelContext = (0, import_react18.createContext)(null);
LabelContext.displayName = "LabelContext";
function useLabelContext() {
  let context = (0, import_react18.useContext)(LabelContext);
  if (context === null) {
...
function useLabelledBy(alwaysAvailableIds) {
  var _a2, _b, _c;
  let labelIds = (_b = (_a2 = (0, import_react18.useContext)(LabelContext)) == null ? void 0 : _a2.value) != null ? _b : void 0;
...
function useLabels({ inherit = false } = {}) {
  ...
  let [labelIds, setLabelIds] = (0, import_react18.useState)([]);
  ...
  return [
    ...
    (0, import_react18.useMemo)(() => {
      return function LabelProvider(props) {
        ...
        let contextBag = (0, import_react18.useMemo)(
          () => ({
            register,
            slot: props.slot,
            name: props.name,
        ...
        return /* @__PURE__ */ import_react18.default.createElement(LabelContext.Provider, { value: contextBag }, props.children);
      };
    }, [setLabelIds])
  ];
}
...
function LabelFn(props, ref) {
  ...
  let disabled = providedDisabled || false;
  let slot = (0, import_react18.useMemo)(() => ({ ...context.slot, disabled }), [context.slot, disabled]);
  let ourProps = {
    ref: labelRef,
    ...context.props,
    id,
...
function CheckboxFn(props, ref) {
  ...
  let d = useDisposables();
  let [changing, setChanging] = (0, import_react19.useState)(false);
  let toggle = useEvent(() => {
    setChanging(true);
  ...
  let reset = (0, import_react19.useCallback)(() => {
    return onChange == null ? void 0 : onChange(defaultChecked);
  }, [
    onChange
    /* Explicitly ignoring `defaultChecked` */
  ]);
  return /* @__PURE__ */ import_react19.default.createElement(import_react19.default.Fragment, null, name != null && /* @__PURE__ */ import_react19.default.createElement(
    FormFields,
    {
      disabled,
      data: { [name]: value || "on" },
...
var CloseContext = (0, import_react20.createContext)(() => {
});
function useClose() {
  return (0, import_react20.useContext)(CloseContext);
}
function CloseProvider({ value, children }) {
  return /* @__PURE__ */ import_react20.default.createElement(CloseContext.Provider, { value }, children);
}

// src/components/close-button/close-button.tsx
function CloseButtonFn(props, ref) {
  let close = useClose();
  return /* @__PURE__ */ import_react21.default.createElement(Button, { ref, ...mergeProps({ onClick: close }, props) });
}
...
function useElementSize(ref, unit = false) {
  ...
  let [identity, forceRerender] = (0, import_react23.useReducer)(() => ({}), {});
  let size2 = (0, import_react23.useMemo)(() => computeSize(element), [element, identity]);
  useIsoMorphicEffect(() => {
    if (!element)
      return;
...
function useOnDisappear(ref, cb, enabled = true) {
...
function useOutsideClick(containers, cb, enabled = true) {
  let enabledRef = (0, import_react27.useRef)(false);
  ...
  let initialClickTarget = (0, import_react27.useRef)(null);
  useDocumentEvent(
    "pointerdown",
    (event) => {
      var _a2, _b;
...
function useOwnerDocument(...args) {
  return (0, import_react28.useMemo)(() => getOwnerDocument(...args), [...args]);
}
...
function useRefocusableInput(ref) {
  let info = (0, import_react30.useRef)({
    value: "",
    selectionStart: null,
    selectionEnd: null
  });
...
function useResolveButtonType(props, ref) {
  let [type, setType] = (0, import_react31.useState)(() => resolveType(props));
  useIsoMorphicEffect(() => {
...
function useStore(store) {
  return (0, import_react32.useSyncExternalStore)(store.subscribe, store.getSnapshot, store.getSnapshot);
}
...
function useTrackedPointer() {
  let lastPos = (0, import_react33.useRef)([-1, -1]);
  return {
    wasMoved(evt) {
      if (false) {
        return true;
...
function useTreeWalker({
  ...
  let acceptRef = (0, import_react34.useRef)(accept);
  let walkRef = (0, import_react34.useRef)(walk);
...
function useWatch(cb, dependencies) {
  let track = (0, import_react35.useRef)([]);
...
var index2 = typeof document !== "undefined" ? import_react37.useLayoutEffect : import_react37.useEffect;
...
var FloatingContext = (0, import_react39.createContext)({
  styles: void 0,
  setReference: () => {
  },
  setFloating: () => {
...
var PlacementContext = (0, import_react39.createContext)(null);
...
function useFloatingReference() {
  return (0, import_react39.useContext)(FloatingContext).setReference;
}
function useFloatingReferenceProps() {
  return (0, import_react39.useContext)(FloatingContext).getReferenceProps;
}
function useFloatingPanelProps() {
  let { getFloatingProps, slot } = (0, import_react39.useContext)(FloatingContext);
...
function useFloatingPanel(placement = null) {
  ...
  let updatePlacementConfig = (0, import_react39.useContext)(PlacementContext);
  let stablePlacement = (0, import_react39.useMemo)(
    () => placement,
    [
      JSON.stringify(
        placement,
  ...
  let context = (0, import_react39.useContext)(FloatingContext);
  return (0, import_react39.useMemo)(
...
function FloatingProvider({
  ...
  let [config, setConfig] = (0, import_react39.useState)(null);
  let [innerOffset, setInnerOffset] = (0, import_react39.useState)(0);
  let overflowRef = (0, import_react39.useRef)(null);
  let [floatingEl, setFloatingElement] = (0, import_react39.useState)(null);
  ...
  if (to === "selection")
    exposedTo = "selection";
  let data = (0, import_react39.useMemo)(
    () => ({
...
function useResolvedConfig(config, element) {
  ...
  let offset2 = useResolvePxValue((_b = config == null ? void 0 : config.offset) != null ? _b : "var(--anchor-offset, 0)", element);
...
function useResolvePxValue(input, element, defaultValue = void 0) {
  ...
  let immediateValue = (0, import_react39.useMemo)(() => computeValue(input, element)[0], [input, element]);
  let [value = immediateValue, setValue] = (0, import_react39.useState)();
  useIsoMorphicEffect(() => {
...
var Context = (0, import_react40.createContext)(null);
Context.displayName = "OpenClosedContext";
function useOpenClosed() {
  return (0, import_react40.useContext)(Context);
}
function OpenClosedProvider({ value, children }) {
  return /* @__PURE__ */ import_react40.default.createElement(Context.Provider, { value }, children);
}
...
function useOnUnmount(cb) {
  ...
  let trulyUnmounted = (0, import_react41.useRef)(false);
...
function useIsHydratingInReact18() {
  ...
  if (!("useSyncExternalStore" in React15)) {
    return false;
  }
  const useSyncExternalStore2 = ((r) => r.useSyncExternalStore)(React15);
...
function useServerHandoffComplete() {
  ...
  let [complete, setComplete] = React15.useState(env.isHandoffComplete);
...
var ForcePortalRootContext = (0, import_react42.createContext)(false);
function usePortalRoot() {
  return (0, import_react42.useContext)(ForcePortalRootContext);
}
function ForcePortalRoot(props) {
  return /* @__PURE__ */ import_react42.default.createElement(ForcePortalRootContext.Provider, { value: props.force }, props.children);
}

// src/components/portal/portal.tsx
function usePortalTarget(ref) {
  let forceInRoot = usePortalRoot();
  let groupTarget = (0, import_react43.useContext)(PortalGroupContext);
  let ownerDocument = useOwnerDocument(ref);
  let [target, setTarget] = (0, import_react43.useState)(() => {
    var _a2;
...
var DEFAULT_PORTAL_TAG = import_react43.Fragment;
var InternalPortalFn = forwardRefWithAs(function InternalPortalFn2(props, ref) {
  let theirProps = props;
  let internalPortalRootRef = (0, import_react43.useRef)(null);
...
function PortalFn(props, ref) {
  ...
  return enabled ? /* @__PURE__ */ import_react43.default.createElement(InternalPortalFn, { ...theirProps, ref: portalRef }) : render({
...
var DEFAULT_GROUP_TAG = import_react43.Fragment;
var PortalGroupContext = (0, import_react43.createContext)(null);
function GroupFn(props, ref) {
  let { target, ...theirProps } = props;
  let groupRef = useSyncRefs(ref);
  let ourProps = { ref: groupRef };
  return /* @__PURE__ */ import_react43.default.createElement(PortalGroupContext.Provider, { value: target }, render({
    ourProps,
    theirProps,
...
var PortalParentContext = (0, import_react43.createContext)(null);
function useNestedPortals() {
  let parent = (0, import_react43.useContext)(PortalParentContext);
  let portals = (0, import_react43.useRef)([]);
  ...
  let api = (0, import_react43.useMemo)(
  ...
  return [
    ...
    (0, import_react43.useMemo)(() => {
      return function PortalWrapper({ children }) {
        return /* @__PURE__ */ import_react43.default.createElement(PortalParentContext.Provider, { value: api }, children);
      };
    }, [api])
  ];
}
...
var reducers = {
  ...
  [2 /* GoToOption */](state, action) {
    ...
    if (state.virtual) {
      let activeOptionIndex2 = action.focus === 4 /* Specific */ ? action.idx : calculateActiveIndex(action, {
        ...
        resolveActiveIndex: () => {
          var _a3, _b2;
          return (_b2 = (_a3 = state.activeOptionIndex) != null ? _a3 : state.virtual.options.findIndex((option) => !state.virtual.disabled(option))) != null ? _b2 : null;
        },
  ...
  [6 /* UpdateVirtualOptions */]: (state, action) => {
    var _a2;
    if (((_a2 = state.virtual) == null ? void 0 : _a2.options) === action.options) {
      return state;
    }
...
var ComboboxActionsContext = (0, import_react44.createContext)(null);
ComboboxActionsContext.displayName = "ComboboxActionsContext";
function useActions(component) {
  let context = (0, import_react44.useContext)(ComboboxActionsContext);
  if (context === null) {
...
var VirtualContext = (0, import_react44.createContext)(null);
function VirtualProvider(props) {
  var _a2;
  let data = useData("VirtualProvider");
  let [paddingStart, paddingEnd] = (0, import_react44.useMemo)(() => {
  ...
  let virtualizer = useVirtualizer({
    ...
    getScrollElement() {
      var _a3;
      return (_a3 = data.optionsRef.current) != null ? _a3 : null;
    },
    overscan: 12
  });
  let [baseKey, setBaseKey] = (0, import_react44.useState)(0);
  useIsoMorphicEffect(() => {
    setBaseKey((v) => v + 1);
  }, [(_a2 = data.virtual) == null ? void 0 : _a2.options]);
  let items = virtualizer.getVirtualItems();
  if (items.length === 0) {
    return null;
  }
  return /* @__PURE__ */ import_react44.default.createElement(VirtualContext.Provider, { value: virtualizer }, /* @__PURE__ */ import_react44.default.createElement(
    "div",
    {
      style: {
        position: "relative",
    ...
    items.map((item) => {
      var _a3;
      return /* @__PURE__ */ import_react44.default.createElement(import_react44.Fragment, { key: item.key }, import_react44.default.cloneElement(
...
var ComboboxDataContext = (0, import_react44.createContext)(null);
ComboboxDataContext.displayName = "ComboboxDataContext";
function useData(component) {
  let context = (0, import_react44.useContext)(ComboboxDataContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <Combobox /> component.`);
    if (Error.captureStackTrace)
...
var DEFAULT_COMBOBOX_TAG = import_react44.Fragment;
function ComboboxFn(props, ref) {
  ...
  let [state, dispatch] = (0, import_react44.useReducer)(stateReducer, {
    dataRef: (0, import_react44.createRef)(),
  ...
  let defaultToFirstOption = (0, import_react44.useRef)(false);
  let optionsPropsRef = (0, import_react44.useRef)({ static: false, hold: false });
  let inputRef = (0, import_react44.useRef)(null);
  let buttonRef = (0, import_react44.useRef)(null);
  let optionsRef = (0, import_react44.useRef)(null);
  ...
  let isSelected = (0, import_react44.useCallback)(
  ...
  let data = (0, import_react44.useMemo)(
    () => ({
      ...state,
      immediate,
      optionsPropsRef,
        ...
        if (defaultToFirstOption.current && state.activeOptionIndex === null && (virtual ? virtual.options.length > 0 : state.options.length > 0)) {
          if (virtual) {
            let localActiveOptionIndex2 = virtual.options.findIndex(
              (option) => {
                var _a3, _b2;
                return !((_b2 = (_a3 = virtual == null ? void 0 : virtual.disabled) == null ? void 0 : _a3.call(virtual, option)) != null ? _b2 : false);
              }
            );
  ...
  let slot = (0, import_react44.useMemo)(() => {
    var _a3, _b2, _c;
    return {
      open: data.comboboxState === 0 /* Open */,
      disabled,
  ...
  let actions = (0, import_react44.useMemo)(
    () => ({
      onChange,
      registerOption,
      goToOption,
  ...
  let reset = (0, import_react44.useCallback)(() => {
  ...
  return /* @__PURE__ */ import_react44.default.createElement(
    ...
    /* @__PURE__ */ import_react44.default.createElement(FloatingProvider, null, /* @__PURE__ */ import_react44.default.createElement(ComboboxActionsContext.Provider, { value: actions }, /* @__PURE__ */ import_react44.default.createElement(ComboboxDataContext.Provider, { value: data }, /* @__PURE__ */ import_react44.default.createElement(
      OpenClosedProvider,
      {
      ...
      name != null && /* @__PURE__ */ import_react44.default.createElement(
        FormFields,
        {
          disabled,
...
function InputFn(props, ref) {
  ...
  let isTyping = (0, import_react44.useRef)(false);
  let d = useDisposables();
  let clear = useEvent(() => {
  ...
  let currentDisplayValue = (0, import_react44.useMemo)(() => {
    var _a3;
  ...
  let isComposing = (0, import_react44.useRef)(false);
  ...
  let debounce2 = useFrameDebounce();
...
function OptionsFn(props, ref) {
  ...
  useScrollLock(
    ownerDocument,
    data.__demoMode ? false : modal && data.comboboxState === 0 /* Open */
  );
  useInertOthers(
    {
      allowed: useEvent(() => [
  ...
  if (data.virtual && visible) {
    Object.assign(theirProps, {
      ...
      children: /* @__PURE__ */ import_react44.default.createElement(VirtualProvider, null, theirProps.children)
    });
  }
  let [frozenValue, setFrozenValue] = (0, import_react44.useState)(data.value);
  if (data.value !== frozenValue && data.comboboxState === 0 /* Open */ && data.mode !== 1 /* Multi */) {
    setFrozenValue(data.value);
  }
  let isSelected = useEvent((compareValue) => {
    return data.compare(frozenValue, compareValue);
  });
  return /* @__PURE__ */ import_react44.default.createElement(Portal, { enabled: portal ? props.static || visible : false }, /* @__PURE__ */ import_react44.default.createElement(
...
function OptionFn(props, ref) {
  ...
  let {
    ...
    value,
    disabled = (_b = (_a2 = data.virtual) == null ? void 0 : _a2.disabled(value)) != null ? _b : false,
    order = null,
    ...theirProps
  } = props;
  let refocusInput = useRefocusableInput(data.inputRef);
  let active = data.virtual ? data.activeOptionIndex === data.calculateIndex(value) : data.activeOptionIndex === null ? false : ((_c = data.options[data.activeOptionIndex]) == null ? void 0 : _c.id) === id;
  let selected = data.isSelected(value);
  let internalOptionRef = (0, import_react44.useRef)(null);
  ...
  let virtualizer = (0, import_react44.useContext)(VirtualContext);
  ...
  let enableScrollIntoView = (0, import_react44.useRef)(data.virtual || data.__demoMode ? false : true);
  useIsoMorphicEffect(() => {
    if (data.virtual)
      return;
    if (data.__demoMode)
...
var DEFAULT_DATA_INTERACTIVE_TAG = import_react45.Fragment;
function DataInteractiveFn(props, ref) {
  ...
  let slot = (0, import_react45.useMemo)(
    () => ({ hover, focus, active }),
    [hover, focus, active]
  );
  return render({
...
function useIsTouchDevice() {
  var _a2;
  let [mq] = (0, import_react46.useState)(
    () => typeof window !== "undefined" && typeof window.matchMedia === "function" ? window.matchMedia("(pointer: coarse)") : null
  );
  let [isTouchDevice, setIsTouchDevice] = (0, import_react46.useState)((_a2 = mq == null ? void 0 : mq.matches) != null ? _a2 : false);
  useIsoMorphicEffect(() => {
    if (!mq)
      return;
...
function useRootContainers({
  ...
  var _a2;
  let mainTreeNodeRef = (0, import_react47.useRef)((_a2 = _mainTreeNodeRef == null ? void 0 : _mainTreeNodeRef.current) != null ? _a2 : null);
  ...
  return {
    ...
    mainTreeNodeRef,
    MainTreeNode: (0, import_react47.useMemo)(() => {
      return function MainTreeNode() {
        if (_mainTreeNodeRef != null)
          return null;
        return /* @__PURE__ */ import_react47.default.createElement(Hidden, { features: 4 /* Hidden */, ref: mainTreeNodeRef });
      };
    }, [mainTreeNodeRef, _mainTreeNodeRef])
  };
}
function useMainTreeNode() {
  let mainTreeNodeRef = (0, import_react47.useRef)(null);
  return {
    mainTreeNodeRef,
    MainTreeNode: (0, import_react47.useMemo)(() => {
      return function MainTreeNode() {
...
var StackContext = (0, import_react48.createContext)(() => {
});
StackContext.displayName = "StackContext";
function useStackContext() {
  return (0, import_react48.useContext)(StackContext);
}
function StackProvider({
  ...
  return /* @__PURE__ */ import_react48.default.createElement(StackContext.Provider, { value: notify }, children);
}
...
function useIsMounted() {
  let mounted = (0, import_react49.useRef)(false);
  useIsoMorphicEffect(() => {
...
function useTabDirection() {
  let direction = (0, import_react50.useRef)(0 /* Forwards */);
  useWindowEvent(
    "keydown",
    (event) => {
      if (event.key === "Tab") {
...
function FocusTrapFn(props, ref) {
  let container = (0, import_react51.useRef)(null);
  ...
  let d = useDisposables();
  let recentlyUsedTabKey = (0, import_react51.useRef)(false);
  let ourProps = {
    ref: focusTrapRef,
    onKeyDown(e) {
      if (e.key == "Tab") {
  ...
  return /* @__PURE__ */ import_react51.default.createElement(import_react51.default.Fragment, null, Boolean(features & 4 /* TabLock */) && /* @__PURE__ */ import_react51.default.createElement(
    Hidden,
    {
      as: "button",
      type: "button",
    ...
    name: "FocusTrap"
  }), Boolean(features & 4 /* TabLock */) && /* @__PURE__ */ import_react51.default.createElement(
    Hidden,
    {
      as: "button",
      type: "button",
...
function useRestoreElement(enabled = true) {
  let localHistory = (0, import_react51.useRef)(history.slice());
  useWatch(
...
function useInitialFocus({
  ...
  let previousActiveElement = (0, import_react51.useRef)(null);
...
var DialogContext = (0, import_react52.createContext)(null);
DialogContext.displayName = "DialogContext";
function useDialogContext(component) {
  let context = (0, import_react52.useContext)(DialogContext);
  if (context === null) {
...
function DialogFn(props, ref) {
  ...
  let [nestedDialogCount, setNestedDialogCount] = (0, import_react52.useState)(0);
  let didWarnOnRole = (0, import_react52.useRef)(false);
  role = function() {
  ...
  let internalDialogRef = (0, import_react52.useRef)(null);
  ...
  let [state, dispatch] = (0, import_react52.useReducer)(stateReducer2, {
    titleId: null,
    descriptionId: null,
    panelRef: (0, import_react52.createRef)()
  });
  ...
  let hasParentDialog = (0, import_react52.useContext)(DialogContext) !== null;
  ...
  useOnDisappear(internalDialogRef, close, dialogState === 0 /* Open */);
  let [describedby, DescriptionProvider] = useDescriptions();
  let contextBag = (0, import_react52.useMemo)(
    () => [{ dialogState, close, setTitleId }, state],
    [dialogState, state, close, setTitleId]
  );
  let slot = (0, import_react52.useMemo)(
  ...
  return /* @__PURE__ */ import_react52.default.createElement(
    ...
    /* @__PURE__ */ import_react52.default.createElement(ForcePortalRoot, { force: true }, /* @__PURE__ */ import_react52.default.createElement(Portal, null, /* @__PURE__ */ import_react52.default.createElement(DialogContext.Provider, { value: contextBag }, /* @__PURE__ */ import_react52.default.createElement(Portal.Group, { target: internalDialogRef }, /* @__PURE__ */ import_react52.default.createElement(ForcePortalRoot, { force: false }, /* @__PURE__ */ import_react52.default.createElement(DescriptionProvider, { slot, name: "Dialog.Description" }, /* @__PURE__ */ import_react52.default.createElement(PortalWrapper, null, /* @__PURE__ */ import_react52.default.createElement(
      FocusTrap,
      {
        initialFocus,
      ...
      /* @__PURE__ */ import_react52.default.createElement(CloseProvider, { value: close }, render({
        ourProps,
        theirProps,
        slot,
    ...
    /* @__PURE__ */ import_react52.default.createElement(HoistFormFields, null, /* @__PURE__ */ import_react52.default.createElement(MainTreeNode, null))
  );
}
...
var startTransition = (
  ...
  (_a = import_react53.default.startTransition) != null ? _a : function startTransition2(cb) {
    cb();
  }
);
...
var DisclosureContext = (0, import_react54.createContext)(null);
DisclosureContext.displayName = "DisclosureContext";
function useDisclosureContext(component) {
  let context = (0, import_react54.useContext)(DisclosureContext);
  if (context === null) {
...
var DisclosureAPIContext = (0, import_react54.createContext)(null);
DisclosureAPIContext.displayName = "DisclosureAPIContext";
function useDisclosureAPIContext(component) {
  let context = (0, import_react54.useContext)(DisclosureAPIContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <Disclosure /> component.`);
    if (Error.captureStackTrace)
...
var DisclosurePanelContext = (0, import_react54.createContext)(null);
DisclosurePanelContext.displayName = "DisclosurePanelContext";
function useDisclosurePanelContext() {
  return (0, import_react54.useContext)(DisclosurePanelContext);
}
function stateReducer3(state, action) {
  return match(action.type, reducers3, state, action);
}
var DEFAULT_DISCLOSURE_TAG = import_react54.Fragment;
function DisclosureFn(props, ref) {
  let { defaultOpen = false, ...theirProps } = props;
  let internalDisclosureRef = (0, import_react54.useRef)(null);
  let disclosureRef = useSyncRefs(
    ...
    optionalRef(
      ...
      props.as === import_react54.Fragment
    )
  );
  let panelRef = (0, import_react54.useRef)(null);
  let buttonRef = (0, import_react54.useRef)(null);
  let reducerBag = (0, import_react54.useReducer)(stateReducer3, {
  ...
  let api = (0, import_react54.useMemo)(() => ({ close }), [close]);
  ...
  return /* @__PURE__ */ import_react54.default.createElement(DisclosureContext.Provider, { value: reducerBag }, /* @__PURE__ */ import_react54.default.createElement(DisclosureAPIContext.Provider, { value: api }, /* @__PURE__ */ import_react54.default.createElement(CloseProvider, { value: close }, /* @__PURE__ */ import_react54.default.createElement(
    OpenClosedProvider,
    {
...
function ButtonFn3(props, ref) {
  ...
  let internalButtonRef = (0, import_react54.useRef)(null);
...
function PanelFn2(props, ref) {
  ...
  return /* @__PURE__ */ import_react54.default.createElement(DisclosurePanelContext.Provider, { value: state.panelId }, render({
    mergeRefs,
    ourProps,
    theirProps,
    slot,
...
function FieldFn(props, ref) {
  let inputId = `headlessui-control-${(0, import_react13.useId)()}`;
  let [labelledby, LabelProvider] = useLabels();
  let [describedBy, DescriptionProvider] = useDescriptions();
  let providedDisabled = useDisabled();
  let { disabled = providedDisabled || false, ...theirProps } = props;
  let slot = (0, import_react55.useMemo)(() => ({ disabled }), [disabled]);
  let ourProps = {
    ref,
    disabled: disabled || void 0,
    "aria-disabled": disabled || void 0
  };
  return /* @__PURE__ */ import_react55.default.createElement(DisabledProvider, { value: disabled }, /* @__PURE__ */ import_react55.default.createElement(LabelProvider, { value: labelledby }, /* @__PURE__ */ import_react55.default.createElement(DescriptionProvider, { value: describedBy }, /* @__PURE__ */ import_react55.default.createElement(IdProvider, { id: inputId }, render({
    ourProps,
    theirProps: {
      ...theirProps,
      children: /* @__PURE__ */ import_react55.default.createElement(FormFieldsProvider, null, typeof theirProps.children === "function" ? theirProps.children(slot) : theirProps.children)
    },
    slot,
...
function FieldsetFn(props, ref) {
  ...
  let { disabled = providedDisabled || false, ...theirProps } = props;
  let [labelledBy, LabelProvider] = useLabels();
  let slot = (0, import_react56.useMemo)(() => ({ disabled }), [disabled]);
  let ourProps = {
    ref,
    role: "group",
    "aria-labelledby": labelledBy,
  ...
  return /* @__PURE__ */ import_react56.default.createElement(DisabledProvider, { value: disabled }, /* @__PURE__ */ import_react56.default.createElement(LabelProvider, null, render({
    ourProps,
    theirProps,
    slot,
...
function LegendFn(props, ref) {
  return /* @__PURE__ */ import_react58.default.createElement(Label, { as: "div", ref, ...props });
}
...
function useComputed(cb, dependencies) {
  let [value, setValue] = (0, import_react59.useState)(cb);
...
function useDidElementMove(element, enabled = true) {
  let elementPosition = (0, import_react60.useRef)({ left: 0, top: 0 });
  useIsoMorphicEffect(() => {
...
function useTextValue(element) {
  let cacheKey = (0, import_react61.useRef)("");
  let cacheValue = (0, import_react61.useRef)("");
  return useEvent(() => {
    let el = element.current;
    if (!el)
      return "";
...
var ListboxActionsContext = (0, import_react62.createContext)(null);
ListboxActionsContext.displayName = "ListboxActionsContext";
function useActions2(component) {
  let context = (0, import_react62.useContext)(ListboxActionsContext);
  if (context === null) {
...
var ListboxDataContext = (0, import_react62.createContext)(null);
ListboxDataContext.displayName = "ListboxDataContext";
function useData2(component) {
  let context = (0, import_react62.useContext)(ListboxDataContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <Listbox /> component.`);
    if (Error.captureStackTrace)
...
var DEFAULT_LISTBOX_TAG = import_react62.Fragment;
function ListboxFn(props, ref) {
  ...
  let [state, dispatch] = (0, import_react62.useReducer)(stateReducer4, {
    dataRef: (0, import_react62.createRef)(),
  ...
  let optionsPropsRef = (0, import_react62.useRef)({ static: false, hold: false });
  let buttonRef = (0, import_react62.useRef)(null);
  let optionsRef = (0, import_react62.useRef)(null);
  let listRef = (0, import_react62.useRef)(/* @__PURE__ */ new Map());
  let compare = useByComparator(by);
  let isSelected = (0, import_react62.useCallback)(
  ...
  let data = (0, import_react62.useMemo)(
    () => ({
      ...state,
      value,
      disabled,
  ...
  let actions = (0, import_react62.useMemo)(
    () => ({
      onChange,
      registerOption,
      goToOption,
  ...
  let reset = (0, import_react62.useCallback)(() => {
    return theirOnChange == null ? void 0 : theirOnChange(defaultValue);
  }, [
    theirOnChange
    /* Explicitly ignoring `defaultValue` */
  ...
  return /* @__PURE__ */ import_react62.default.createElement(
    ...
    /* @__PURE__ */ import_react62.default.createElement(FloatingProvider, null, /* @__PURE__ */ import_react62.default.createElement(ListboxActionsContext.Provider, { value: actions }, /* @__PURE__ */ import_react62.default.createElement(ListboxDataContext.Provider, { value: data }, /* @__PURE__ */ import_react62.default.createElement(
      OpenClosedProvider,
      {
      ...
      name != null && value != null && /* @__PURE__ */ import_react62.default.createElement(
        FormFields,
        {
          disabled,
          data: { [name]: value },
...
var SelectedOptionContext = (0, import_react62.createContext)(false);
...
function OptionsFn2(props, ref) {
  ...
  useScrollLock(
    ownerDocument,
    data.__demoMode ? false : modal && data.listboxState === 0 /* Open */
  );
  useInertOthers(
    { allowed: useEvent(() => [data.buttonRef.current, data.optionsRef.current]) },
    data.__demoMode ? false : modal && data.listboxState === 0 /* Open */
  );
  let initialOption = (0, import_react62.useRef)(null);
  ...
  let [frozenValue, setFrozenValue] = (0, import_react62.useState)(data.value);
  ...
  return /* @__PURE__ */ import_react62.default.createElement(Portal, { enabled: portal ? props.static || visible : false }, /* @__PURE__ */ import_react62.default.createElement(
...
function OptionFn2(props, ref) {
  ...
  let usedInSelectedOption = (0, import_react62.useContext)(SelectedOptionContext) === true;
  ...
  let selected = data.isSelected(value);
  let internalOptionRef = (0, import_react62.useRef)(null);
...
var DEFAULT_SELECTED_OPTION_TAG = import_react62.Fragment;
function SelectedFn(props, ref) {
  ...
  return /* @__PURE__ */ import_react62.default.createElement(SelectedOptionContext.Provider, { value: true }, render({
    ourProps,
    theirProps: {
      ...theirProps,
      children: /* @__PURE__ */ import_react62.default.createElement(import_react62.default.Fragment, null, placeholder && shouldShowPlaceholder ? placeholder : children)
    },
    slot,
...
var MenuContext = (0, import_react63.createContext)(null);
MenuContext.displayName = "MenuContext";
function useMenuContext(component) {
  let context = (0, import_react63.useContext)(MenuContext);
  if (context === null) {
...
var DEFAULT_MENU_TAG = import_react63.Fragment;
function MenuFn(props, ref) {
  let { __demoMode = false, ...theirProps } = props;
  let reducerBag = (0, import_react63.useReducer)(stateReducer5, {
    __demoMode,
    menuState: __demoMode ? 0 /* Open */ : 1 /* Closed */,
    buttonRef: (0, import_react63.createRef)(),
    itemsRef: (0, import_react63.createRef)(),
    items: [],
    searchQuery: "",
    activeItemIndex: null,
    activationTrigger: 1 /* Other */
  ...
  return /* @__PURE__ */ import_react63.default.createElement(FloatingProvider, null, /* @__PURE__ */ import_react63.default.createElement(MenuContext.Provider, { value: reducerBag }, /* @__PURE__ */ import_react63.default.createElement(
    OpenClosedProvider,
    {
...
function ButtonFn5(props, ref) {
  ...
  let handleClick = useEvent((event) => {
    ...
    if (state.menuState === 0 /* Open */) {
      ...
      d.nextFrame(() => {
        var _a3;
        return (_a3 = state.buttonRef.current) == null ? void 0 : _a3.focus({ preventScroll: true });
      });
    } else {
      event.preventDefault();
      dispatch({ type: 0 /* OpenMenu */ });
...
function ItemsFn(props, ref) {
  ...
  useOnDisappear(state.buttonRef, () => dispatch({ type: 1 /* CloseMenu */ }), visible);
  useScrollLock(
    ownerDocument,
    state.__demoMode ? false : modal && state.menuState === 0 /* Open */
  );
  useInertOthers(
  ...
  return /* @__PURE__ */ import_react63.default.createElement(Portal, { enabled: portal ? props.static || visible : false }, render({
    ourProps,
    theirProps,
    slot,
...
var DEFAULT_ITEM_TAG = import_react63.Fragment;
function ItemFn(props, ref) {
  ...
  let internalItemRef = (0, import_react63.useRef)(null);
  ...
  let bag = (0, import_react63.useRef)({
    disabled,
  ...
  return /* @__PURE__ */ import_react63.default.createElement(LabelProvider, null, /* @__PURE__ */ import_react63.default.createElement(DescriptionProvider, null, render({
    ourProps,
    theirProps,
    slot,
...
function SectionFn(props, ref) {
  ...
  return /* @__PURE__ */ import_react63.default.createElement(LabelProvider, null, render({
    ourProps,
    theirProps,
    slot: {},
...
var PopoverContext = (0, import_react64.createContext)(null);
PopoverContext.displayName = "PopoverContext";
function usePopoverContext(component) {
  let context = (0, import_react64.useContext)(PopoverContext);
  if (context === null) {
...
var PopoverAPIContext = (0, import_react64.createContext)(null);
PopoverAPIContext.displayName = "PopoverAPIContext";
function usePopoverAPIContext(component) {
  let context = (0, import_react64.useContext)(PopoverAPIContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <Popover /> component.`);
    if (Error.captureStackTrace)
...
var PopoverGroupContext = (0, import_react64.createContext)(null);
PopoverGroupContext.displayName = "PopoverGroupContext";
function usePopoverGroupContext() {
  return (0, import_react64.useContext)(PopoverGroupContext);
}
var PopoverPanelContext = (0, import_react64.createContext)(null);
PopoverPanelContext.displayName = "PopoverPanelContext";
function usePopoverPanelContext() {
  return (0, import_react64.useContext)(PopoverPanelContext);
}
...
function PopoverFn(props, ref) {
  var _a2;
  let { __demoMode = false, ...theirProps } = props;
  let internalPopoverRef = (0, import_react64.useRef)(null);
  ...
  let buttons = (0, import_react64.useRef)([]);
  let reducerBag = (0, import_react64.useReducer)(stateReducer6, {
    __demoMode,
    ...
    panel: null,
    panelId: null,
    beforePanelSentinel: (0, import_react64.createRef)(),
    afterPanelSentinel: (0, import_react64.createRef)()
  });
  let [
  ...
  let isPortalled = (0, import_react64.useMemo)(() => {
    if (!button)
      return false;
    if (!panel)
      return false;
  ...
  let registerBag = (0, import_react64.useMemo)(
    () => ({
  ...
  (0, import_react64.useEffect)(() => registerPopover == null ? void 0 : registerPopover(registerBag), [registerPopover, registerBag]);
  let [portals, PortalWrapper] = useNestedPortals();
  ...
  let api = (0, import_react64.useMemo)(
    () => ({ close, isPortalled }),
    [close, isPortalled]
  );
  ...
  return /* @__PURE__ */ import_react64.default.createElement(FloatingProvider, null, /* @__PURE__ */ import_react64.default.createElement(PopoverPanelContext.Provider, { value: null }, /* @__PURE__ */ import_react64.default.createElement(PopoverContext.Provider, { value: reducerBag }, /* @__PURE__ */ import_react64.default.createElement(PopoverAPIContext.Provider, { value: api }, /* @__PURE__ */ import_react64.default.createElement(CloseProvider, { value: close }, /* @__PURE__ */ import_react64.default.createElement(
    OpenClosedProvider,
    {
    ...
    /* @__PURE__ */ import_react64.default.createElement(PortalWrapper, null, render({
      ourProps,
      theirProps,
      slot,
      defaultTag: DEFAULT_POPOVER_TAG,
      name: "Popover"
    }), /* @__PURE__ */ import_react64.default.createElement(root.MainTreeNode, null))
  ))))));
}
...
function ButtonFn6(props, ref) {
  ...
  let sentinelId = `headlessui-focus-sentinel-${(0, import_react13.useId)()}`;
  let groupContext = usePopoverGroupContext();
  ...
  let [uniqueIdentifier] = (0, import_react64.useState)(() => Symbol());
  ...
  return /* @__PURE__ */ import_react64.default.createElement(import_react64.default.Fragment, null, render({
    ourProps,
    theirProps,
    slot,
    defaultTag: DEFAULT_BUTTON_TAG6,
    name: "Popover.Button"
  }), visible && !isWithinPanel && isPortalled && /* @__PURE__ */ import_react64.default.createElement(
    Hidden,
    {
      id: sentinelId,
      features: 2 /* Focusable */,
...
function PanelFn3(props, ref) {
  ...
  let internalPanelRef = (0, import_react64.useRef)(null);
  let anchor = useResolvedAnchor(rawAnchor);
  let [floatingRef, style] = useFloatingPanel(anchor);
  let getFloatingPanelProps = useFloatingPanelProps();
  if (anchor) {
  ...
  useOnDisappear(state.button, () => dispatch({ type: 1 /* ClosePopover */ }), visible);
  ...
  return /* @__PURE__ */ import_react64.default.createElement(PopoverPanelContext.Provider, { value: id }, /* @__PURE__ */ import_react64.default.createElement(PopoverAPIContext.Provider, { value: { close, isPortalled } }, /* @__PURE__ */ import_react64.default.createElement(Portal, { enabled: portal ? props.static || visible : false }, visible && isPortalled && /* @__PURE__ */ import_react64.default.createElement(
    Hidden,
    {
    ...
    visible,
    name: "Popover.Panel"
  }), visible && isPortalled && /* @__PURE__ */ import_react64.default.createElement(
    Hidden,
    {
...
function GroupFn2(props, ref) {
  let internalGroupRef = (0, import_react64.useRef)(null);
  let groupRef = useSyncRefs(internalGroupRef, ref);
  let [popovers, setPopovers] = (0, import_react64.useState)([]);
  ...
  let contextBag = (0, import_react64.useMemo)(
    () => ({
      registerPopover,
      unregisterPopover,
  ...
  let theirProps = props;
  let ourProps = { ref: groupRef };
  return /* @__PURE__ */ import_react64.default.createElement(PopoverGroupContext.Provider, { value: contextBag }, render({
    ourProps,
    theirProps,
    slot,
...
var PopoverOverlay = forwardRefWithAs(OverlayFn);
...
var RadioGroupDataContext = (0, import_react65.createContext)(null);
RadioGroupDataContext.displayName = "RadioGroupDataContext";
function useData3(component) {
  let context = (0, import_react65.useContext)(RadioGroupDataContext);
  if (context === null) {
...
var RadioGroupActionsContext = (0, import_react65.createContext)(null);
RadioGroupActionsContext.displayName = "RadioGroupActionsContext";
function useActions3(component) {
  let context = (0, import_react65.useContext)(RadioGroupActionsContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <RadioGroup /> component.`);
    if (Error.captureStackTrace)
...
function RadioGroupFn(props, ref) {
  ...
  let compare = useByComparator(by);
  let [state, dispatch] = (0, import_react65.useReducer)(stateReducer7, { options: [] });
  let options = state.options;
  let [labelledby, LabelProvider] = useLabels();
  let [describedby, DescriptionProvider] = useDescriptions();
  let internalRadioGroupRef = (0, import_react65.useRef)(null);
  ...
  let firstOption = (0, import_react65.useMemo)(
    () => options.find((option) => {
  ...
  let containsCheckedOption = (0, import_react65.useMemo)(
  ...
  let radioGroupData = (0, import_react65.useMemo)(
    () => ({ value, firstOption, containsCheckedOption, disabled, compare, ...state }),
    [value, firstOption, containsCheckedOption, disabled, compare, state]
  );
  let radioGroupActions = (0, import_react65.useMemo)(
  ...
  let slot = (0, import_react65.useMemo)(() => ({ value }), [value]);
  ...
  return /* @__PURE__ */ import_react65.default.createElement(DescriptionProvider, { name: "RadioGroup.Description" }, /* @__PURE__ */ import_react65.default.createElement(LabelProvider, { name: "RadioGroup.Label" }, /* @__PURE__ */ import_react65.default.createElement(RadioGroupActionsContext.Provider, { value: radioGroupActions }, /* @__PURE__ */ import_react65.default.createElement(RadioGroupDataContext.Provider, { value: radioGroupData }, name != null && /* @__PURE__ */ import_react65.default.createElement(
    FormFields,
    {
      disabled,
      data: { [name]: value || "on" },
...
function OptionFn3(props, ref) {
  ...
  let internalOptionRef = (0, import_react65.useRef)(null);
  ...
  return /* @__PURE__ */ import_react65.default.createElement(DescriptionProvider, { name: "RadioGroup.Description" }, /* @__PURE__ */ import_react65.default.createElement(LabelProvider, { name: "RadioGroup.Label" }, render({
    ourProps,
    theirProps,
    slot,
...
function RadioFn(props, ref) {
  ...
  let internalRadioRef = (0, import_react65.useRef)(null);
...
var GroupContext = (0, import_react67.createContext)(null);
GroupContext.displayName = "GroupContext";
var DEFAULT_GROUP_TAG3 = import_react67.Fragment;
function GroupFn3(props) {
  var _a2;
  let [switchElement, setSwitchElement] = (0, import_react67.useState)(null);
  let [labelledby, LabelProvider] = useLabels();
  let [describedby, DescriptionProvider] = useDescriptions();
  let context = (0, import_react67.useMemo)(
    () => ({ switch: switchElement, setSwitch: setSwitchElement }),
    [switchElement, setSwitchElement]
  );
  let ourProps = {};
  let theirProps = props;
  return /* @__PURE__ */ import_react67.default.createElement(DescriptionProvider, { name: "Switch.Description", value: describedby }, /* @__PURE__ */ import_react67.default.createElement(
    LabelProvider,
    {
      name: "Switch.Label",
      value: labelledby,
    ...
    /* @__PURE__ */ import_react67.default.createElement(GroupContext.Provider, { value: context }, render({
      ourProps,
      theirProps,
      slot: {},
...
function SwitchFn(props, ref) {
  ...
  let groupContext = (0, import_react67.useContext)(GroupContext);
  let internalSwitchRef = (0, import_react67.useRef)(null);
  ...
  let [checked, onChange] = useControllable(controlledChecked, controlledOnChange, defaultChecked);
  let d = useDisposables();
  let [changing, setChanging] = (0, import_react67.useState)(false);
  let toggle = useEvent(() => {
    setChanging(true);
    onChange == null ? void 0 : onChange(!checked);
    d.nextFrame(() => {
  ...
  let reset = (0, import_react67.useCallback)(() => {
    return onChange == null ? void 0 : onChange(defaultChecked);
  }, [
    onChange
    /* Explicitly ignoring `defaultChecked` */
  ]);
  return /* @__PURE__ */ import_react67.default.createElement(import_react67.default.Fragment, null, name != null && /* @__PURE__ */ import_react67.default.createElement(
    FormFields,
    {
      disabled,
      data: { [name]: value || "on" },
...
function FocusSentinel({ onFocus }) {
  let [enabled, setEnabled] = (0, import_react68.useState)(true);
  let mounted = useIsMounted();
  if (!enabled)
    return null;
...
var StableCollectionContext = React34.createContext(null);
...
function StableCollection({ children }) {
  let collection = React34.useRef(createCollection());
  return /* @__PURE__ */ React34.createElement(StableCollectionContext.Provider, { value: collection }, children);
}
function useStableCollectionIndex(group) {
  let collection = React34.useContext(StableCollectionContext);
  if (!collection)
...
function useStableCollectionKey() {
  ...
  let owner = (
    // @ts-ignore
    (_c = (_b = (_a2 = React34.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED) == null ? void 0 : _a2.ReactCurrentOwner) == null ? void 0 : _b.current) != null ? _c : null
  );
  if (!owner)
    return Symbol();
  let indexes = [];
...
var TabsDataContext = (0, import_react69.createContext)(null);
TabsDataContext.displayName = "TabsDataContext";
function useData4(component) {
  let context = (0, import_react69.useContext)(TabsDataContext);
  if (context === null) {
...
var TabsActionsContext = (0, import_react69.createContext)(null);
TabsActionsContext.displayName = "TabsActionsContext";
function useActions4(component) {
  let context = (0, import_react69.useContext)(TabsActionsContext);
  if (context === null) {
    let err = new Error(`<${component} /> is missing a parent <Tab.Group /> component.`);
    if (Error.captureStackTrace)
...
function GroupFn4(props, ref) {
  ...
  let [state, dispatch] = (0, import_react69.useReducer)(stateReducer8, {
    info,
  ...
  let tabsData = (0, import_react69.useMemo)(
  ...
  let tabsActions = (0, import_react69.useMemo)(() => ({ registerTab, registerPanel, change }), []);
  useIsoMorphicEffect(() => {
  ...
  return /* @__PURE__ */ import_react69.default.createElement(StableCollection, null, /* @__PURE__ */ import_react69.default.createElement(TabsActionsContext.Provider, { value: tabsActions }, /* @__PURE__ */ import_react69.default.createElement(TabsDataContext.Provider, { value: tabsData }, tabsData.tabs.length <= 0 && /* @__PURE__ */ import_react69.default.createElement(
    FocusSentinel,
    {
      onFocus: () => {
        var _a2, _b;
...
function ListFn(props, ref) {
  ...
  let slot = (0, import_react69.useMemo)(() => ({ selectedIndex }), [selectedIndex]);
  let theirProps = props;
  let ourProps = {
    ref: listRef,
    role: "tablist",
...
function TabFn(props, ref) {
  ...
  let internalTabRef = (0, import_react69.useRef)(null);
  ...
  let ready = (0, import_react69.useRef)(false);
...
function PanelFn4(props, ref) {
  ...
  let internalPanelRef = (0, import_react69.useRef)(null);
  ...
  let selected = myIndex === selectedIndex;
  let { isFocusVisible: focus, focusProps } = $f7dceffc5ad7768b$export$4e328f61c538687f();
  let slot = (0, import_react69.useMemo)(() => ({ selected, focus }), [selected, focus]);
  let ourProps = mergeProps(
    {
      ref: panelRef,
      id,
  ...
  if (!selected && ((_c = theirProps.unmount) != null ? _c : true) && !((_d = theirProps.static) != null ? _d : false)) {
    return /* @__PURE__ */ import_react69.default.createElement(Hidden, { as: "span", "aria-hidden": "true", ...ourProps });
  }
  return render({
    ourProps,
    theirProps,
...
function TextareaFn(props, ref) {
  ...
  let slot = (0, import_react70.useMemo)(() => {
    return { disabled, invalid, hover, focus, autofocus: autoFocus };
  }, [disabled, invalid, hover, focus, autoFocus]);
  return render({
    ourProps,
...
function useFlags(initialFlags = 0) {
  let [flags, setFlags] = (0, import_react71.useState)(initialFlags);
  let mounted = useIsMounted();
  let addFlag = (0, import_react71.useCallback)(
    (flag) => {
      if (!mounted.current)
        return;
  ...
  let hasFlag = (0, import_react71.useCallback)((flag) => Boolean(flags & flag), [flags]);
  let removeFlag = (0, import_react71.useCallback)(
    (flag) => {
      if (!mounted.current)
        return;
      setFlags((flags2) => flags2 & ~flag);
  ...
  let toggleFlag = (0, import_react71.useCallback)(
    (flag) => {
      if (!mounted.current)
        return;
      setFlags((flags2) => flags2 ^ flag);
...
function useTransition({ container, direction, classes, onStart, onStop }) {
  let mounted = useIsMounted();
  let d = useDisposables();
  let inFlight = (0, import_react72.useRef)(false);
  useIsoMorphicEffect(() => {
    if (direction === "idle")
      return;
    if (!mounted.current)
...
function shouldForwardRef(props) {
  ...
  return (
    ...
    ((_a2 = props.as) != null ? _a2 : DEFAULT_TRANSITION_CHILD_TAG) !== import_react73.Fragment || // If we have a single child, then we can forward the ref directly
    import_react73.default.Children.count(props.children) === 1
  );
}
var TransitionContext = (0, import_react73.createContext)(null);
TransitionContext.displayName = "TransitionContext";
function useTransitionContext() {
  let context = (0, import_react73.useContext)(TransitionContext);
  if (context === null) {
    throw new Error(
...
function useParentNesting() {
  let context = (0, import_react73.useContext)(NestingContext);
  if (context === null) {
    throw new Error(
      "A <Transition.Child /> is used but it is missing a parent <Transition /> or <Transition.Root />."
    );
...
var NestingContext = (0, import_react73.createContext)(null);
...
function useNesting(done, parent) {
  ...
  let transitionableChildren = (0, import_react73.useRef)([]);
  let mounted = useIsMounted();
  let d = useDisposables();
  ...
  let todos = (0, import_react73.useRef)([]);
  let wait = (0, import_react73.useRef)(Promise.resolve());
  let chains = (0, import_react73.useRef)({
    enter: [],
    leave: [],
    idle: []
  });
...
var DEFAULT_TRANSITION_CHILD_TAG = import_react73.Fragment;
...
function TransitionChildFn(props, ref) {
  ...
  let container = (0, import_react73.useRef)(null);
  let requiresRef = shouldForwardRef(props);
  let transitionRef = useSyncRefs(...requiresRef ? [container, ref] : ref === null ? [] : [ref]);
  let strategy = ((_a2 = rest.unmount) != null ? _a2 : true) ? 0 /* Unmount */ : 1 /* Hidden */;
  let { show, appear, initial } = useTransitionContext();
  let [state, setState] = (0, import_react73.useState)(show ? "visible" /* Visible */ : "hidden" /* Hidden */);
  ...
  let beforeEvent = useEvent((direction) => {
    return match(direction, {
      enter: () => {
        ...
        (_b2 = (_a3 = events.current).beforeEnter) == null ? void 0 : _b2.call(_a3);
      },
      leave: () => {
        var _a3, _b2;
        transitionStateFlags.addFlag(4 /* Closing */);
        (_b2 = (_a3 = events.current).beforeLeave) == null ? void 0 : _b2.call(_a3);
      },
      idle: () => {
      }
    });
  ...
  let afterEvent = useEvent((direction) => {
    return match(direction, {
      enter: () => {
        ...
        (_b2 = (_a3 = events.current).afterEnter) == null ? void 0 : _b2.call(_a3);
      },
      leave: () => {
        var _a3, _b2;
        transitionStateFlags.removeFlag(4 /* Closing */);
        (_b2 = (_a3 = events.current).afterLeave) == null ? void 0 : _b2.call(_a3);
      },
      idle: () => {
      }
    });
  });
  let isTransitioning = (0, import_react73.useRef)(false);
  ...
  if (immediate) {
    ...
    theirProps.className = classNames(
      rest.className,
      (_c = container.current) == null ? void 0 : _c.className,
  ...
  return /* @__PURE__ */ import_react73.default.createElement(NestingContext.Provider, { value: nesting }, /* @__PURE__ */ import_react73.default.createElement(
    OpenClosedProvider,
    {
      value: match(state, {
...
function TransitionRootFn(props, ref) {
  ...
  let internalTransitionRef = (0, import_react73.useRef)(null);
  let requiresRef = shouldForwardRef(props);
  ...
  let [initial, setInitial] = (0, import_react73.useState)(true);
  let changes = (0, import_react73.useRef)([show]);
  useIsoMorphicEffect(() => {
    if (initial === false) {
      return;
    }
  ...
  let transitionBag = (0, import_react73.useMemo)(
    () => ({ show, appear, initial }),
    [show, appear, initial]
  );
  useOnDisappear(internalTransitionRef, () => setState("hidden" /* Hidden */));
  useIsoMorphicEffect(() => {
    if (show) {
      setState("visible" /* Visible */);
  ...
  return /* @__PURE__ */ import_react73.default.createElement(NestingContext.Provider, { value: nestingBag }, /* @__PURE__ */ import_react73.default.createElement(TransitionContext.Provider, { value: transitionBag }, render({
    ourProps: {
      ...sharedProps,
      as: import_react73.Fragment,
      children: /* @__PURE__ */ import_react73.default.createElement(
    ...
    theirProps: {},
    defaultTag: import_react73.Fragment,
    features: TransitionChildRenderFeatures,
    visible: state === "visible" /* Visible */,
    name: "Transition"
  })));
...
function ChildFn(props, ref) {
  let hasTransitionContext = (0, import_react73.useContext)(TransitionContext) !== null;
  let hasOpenClosedContext = useOpenClosed() !== null;
  return /* @__PURE__ */ import_react73.default.createElement(import_react73.default.Fragment, null, !hasTransitionContext && hasOpenClosedContext ? (
    // @ts-expect-error This is an object
    /* @__PURE__ */ import_react73.default.createElement(TransitionRoot, { ref, ...props })
  ) : (
    // @ts-expect-error This is an object
    /* @__PURE__ */ import_react73.default.createElement(InternalTransitionChild, { ref, ...props })
  ));
}
